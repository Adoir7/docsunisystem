<?php
	//atualiza a pagina automaticamente pelo tempo definido em segundos no "content";
	//a cada 1 minuto a pagaina é atualizada.
	echo '<meta http-equiv="refresh" content="60; url="<?php echo URL_BASE ?>';
?>
    ...
    <div class="col-md-3">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Fila de Testes
          </h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table class="table table-bordered">
            ...
            <?php foreach ($ocorrenciasigacq as $registros) {  ?>
              <tr>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($lista_ch_aguardando as $registros) { ?>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td><?php echo $registros->ULTIMOANALISTA ?></td>
                                </tr>
